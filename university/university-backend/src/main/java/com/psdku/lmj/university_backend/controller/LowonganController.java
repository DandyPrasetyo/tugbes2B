...
// Tambahkan import ini supaya @PostMapping, @PutMapping, @DeleteMapping tidak merah
...
public class LowonganController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse> createLowongan(@RequestBody Lowongan lowongan) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse> updateLowongan(@PathVariable Long id, @RequestBody Lowongan updatedLowongan) {
